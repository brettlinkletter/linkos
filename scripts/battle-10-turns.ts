...
const conversations: AgentConvo[] = [
  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    turns: [
      ...
      { user: 'I am building LinkOS as an open source project. The repo is at scanbott/linkos on GitHub. It is a Telegram bot powered by Claude Code that runs as a persistent service. I want it to become the reference implementation for personal AI assistants.', assistant: 'Noted. LinkOS is your open-source reference implementation for personal AI assistants, living at scanbott/linkos.', expectStore: true, label: 'project context' },
    ],
  },
