...
async function run() {
  ...
  console.log('  To clean: sqlite3 store/linkos.db "PRAGMA trusted_schema=ON; DELETE FROM memories WHERE chat_id=\'[CHAT_ID]\'; DELETE FROM consolidations WHERE chat_id=\'[CHAT_ID]\';"');
